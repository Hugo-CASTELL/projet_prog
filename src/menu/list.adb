package body List is
   ...
   begin
     if IsFull(List) then
       raise Program_Error with "Cannot add element: List is full.";
     else
   ...
   begin
     ...
     if Size_List1 + Size_List2 > Capacity then
       raise Program_Error with "Concatenation exceeds list capacity.";
     else
